...
var MessageComponent = (function () {
  function MessageComponent(resourceService) {
...
var ViewComponent = (function (_super) {
  ...
  function ViewComponent(param, resourceService, showError, getLocale, loading) {
...
var BaseComponent = (function (_super) {
  ...
  function BaseComponent(resourceService, ui, getLocale, loading) {
    var _this = _super.call(this, resourceService, getLocale) || this;
    _this.loading = loading;
    _this.uiS1 = ui;
    _this.getModelName = _this.getModelName.bind(_this);
...
var EditComponent = (function (_super) {
  ...
  function EditComponent(service, resourceService, ui, showMessage, showError, confirm, getLocale, loading, patchable, backOnSaveSuccess) {
    var _this = _super.call(this, resourceService, ui, getLocale, loading) || this;
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            if (data && data.status === 404) {
              ...
              core_1.error(err_2, this.resourceService, this.showError);
            }
            return [3, 5];
          case 4:
            com.running = false;
  ...
  EditComponent.prototype.formatModel = function (obj) {
    ...
    model_formatter_1.format(obj, this.metamodel, locale, this.getCurrencyCode(), this.currencySymbol());
  };
  ...
  EditComponent.prototype.getModel = function () {
    ...
    model_formatter_1.json(obj, this.metamodel, locale, this.getCurrencyCode());
    return obj;
  };
  ...
  EditComponent.prototype.onSave = function (isBack) {
    ...
    if (this.newMode && this.addable !== true) {
      var msg = core_1.message(r, 'error_permission_add', 'error_permission');
      this.showError(msg.message, msg.title);
      return;
    }
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 9:
            err_3 = _a.sent();
            core_1.error(err_3, this.resourceService, this.showError);
            return [3, 10];
          case 10: return [2];
        }
      });
...
var SearchComponent = (function (_super) {
  ...
  function SearchComponent(param, resourceService, ui, showMessage, showError, getLocale, loading) {
    var _this = _super.call(this, resourceService, ui, getLocale, loading) || this;
    _this.ui = ui;
    _this.showMessage = showMessage;
    _this.showError = showError;
  ...
  SearchComponent.prototype.getModelName = function () {
    return 'state';
  };
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            err_4 = _a.sent();
            core_1.error(err_4, this.resourceService, this.showError);
            return [3, 7];
          case 6:
            this.running = false;
            if (this.loading) {
  ...
  SearchComponent.prototype.searchError = function (response) {
    ...
    core_1.error(response, this.resourceService, this.showError);
  };
