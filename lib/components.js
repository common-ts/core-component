...
var EditComponent=(function(_super){
  ...
  function EditComponent(service, resourceService, ui, getLocale, showMessage, showError, confirm, loading, patchable, backOnSaveSuccess){
...
var SearchComponent=(function(_super){
  ...
  SearchComponent.prototype.search=function(se){
    return __awaiter(this, void 0, void 0,function(){
      var ctx, result, err_4;
      return __generator(this,function(_a){
        switch (_a.label){
          case 0:
            _a.trys.push([0, 2, , 3]);
            ctx = {};
            return [4, this.service.search(se, ctx)];
          case 1:
            result = _a.sent();
